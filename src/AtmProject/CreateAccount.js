...
const CreateAccount = () => {
  ...
  const submitForm = (e) => {
    ...
    for (let i = 0; i < data.length; i++) {
      if (accountNo === data[i].accountNo) {
        count++;
      }
    }
    if (count >= 1) {
      alert("Account already existed please try with some other number");
    } else {
      axios
      ...
      >
        <div className="form-group col-6 mb-2">
          ...
          <input
            ...
            type="text"
            placeholder="3731-8304-2322-5259"
            {...register("accountNo", {
              required: true,
          ...
          <span className="text-danger">
            {errors.accountNo?.type === "required" && "Enter valid number"}
          </span>
          <span className="text-danger">
            {errors.accountNo?.type === "pattern" &&
              "Enter 20 Numbers and hyphen For Every 4 Digits (3731-8304-2322-5259)"}
          </span>
        </div>
        <div className="form-group col-6 mb-2">
          ...
          <span className="text-danger">
            {errors.name?.type === "minLength" &&
              "Need To Enter More Than 3 Characters"}
          </span>
          <span className="text-danger">
            {errors.name?.type === "maxLength" &&
              "Need To Enter Less Than 16 Characters"}
          </span>
        </div>
        <div className="form-group col-6 mb-2">
          <lable>Date</lable>
          ...
          />
          <span className="text-danger">
            {errors.date?.type === "required" && "Please Select Date From List"}
          </span>
        </div>
        <div className="form-group col-6 mb-2">
          <lable>Balance</lable>
          ...
          />
          <span className="text-danger">
            {errors.balance?.type === "required" && "Please Enter Amount"}
          </span>
          <span className="text-danger">
            {errors.balance?.type === "pattern" &&
              "Please Enter Minimum Of 500 Rs"}
          </span>
        </div>
        <div className="form-group col-6 mb-2">
          <lable>Deposit</lable>
          <input
            ...
            id="deposit"
            value={deposit}
            onChange={(e) => changeDetails(e, "deposit")}
            disabled="true"
          />
        </div>
        <div className="form-group col-6 mb-2">
          ...
          <input
            ...
            id="withDraw"
            value={withDraw}
            onChange={(e) => changeDetails(e, "withDraw")}
            disabled="true"
          />
        </div>
        <div className="form-group col-6 mb-2">
          ...
          />
          <span className="text-danger">
            {errors.location?.type === "required" && "Enter Location"}
          </span>
          <span className="text-danger">
